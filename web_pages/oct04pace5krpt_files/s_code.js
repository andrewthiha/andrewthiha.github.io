...
var s_account="wassermanrunningnetwork"
...
s.linkInternalFilters="javascript:,runningnetwork.com"
...
/* Plugin Example: split v1.5
var newArray=s.split(string,",")
*/

/* Plugin: apl v1.1 (Append List) */
s.events=s.apl(s.events,"event2",",",2)

if(s.prop1)
s.events=s.apl(s.events,"event1",",",2)

/* Lowercase variables - internal search term */
if(s.prop1)s.prop1=s.prop1.toLowerCase()

/* Call Time parting plugin */
...
/*populate the eVars with Time values */
s.eVar11=s.prop11;
s.eVar12=s.prop12;
s.eVar13=s.prop13;

/* Populate content segment variables */
s.eVar3=s.prop3;
s.eVar4=s.prop4;
s.eVar5=s.prop5;
s.eVar6=s.prop6;
...
s.visitorNamespace="wassermanmedia"
s.trackingServer="metric.runningnetwork.com"
s.dc=112
